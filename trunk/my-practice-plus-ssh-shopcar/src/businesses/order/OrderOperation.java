/**
 * 文件：order.OrderOperation.java
 * URL：order/order_manager.jsp?orderid=xx
 * 说明：实现对订单的增删修查
 * 		订单的增：即购物车中商品的结算
 * 方法：通过判定method=add/delete/update/query,分别对应订单的增/删/修/查
 * 时间：08-05-16
 */
...
public class OrderOperation extends HttpServlet {
	...
	/**
	 * 说明:订单结算
	 * 方法：从cookie中读取存放的pid和商品数量
	 * 表示：cookie以pro_开头的即为用户下的订单，内容为欲购买的数量
	 */
	...
	/*
	 * 说明：订单更新
	 * 方法：从订单表中把tid为orderid的记录的订单数量tamount修改为传来的数量
	 */
