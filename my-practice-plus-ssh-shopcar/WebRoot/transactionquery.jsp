...
<body topmargin="0" bgcolor="#dce0e1" onLoad="load();">
	<table align="center" border="0" width="778" cellspacing="0" cellpadding="0">
		<tr valign="top">
			<td><jsp:include flush="true" page="subpage/head.jsp"></jsp:include>
			</td>
		</tr>
		<tr valign="top">
			<td><jsp:include flush="true" page="subpage/navigate.jsp"></jsp:include>
			</td>
		</tr>
		<tr valign="top">
			<td>
																...
																<tr>
																	<td>
																		<table style='padding-top:10px;' border="1" width="100%" cellspacing="0" cellpadding="0">
																			<tr>
																				<td align="center"><login:transactionquery></login:transactionquery>
																				</td>
																			</tr>
																		</table>
																	</td>
