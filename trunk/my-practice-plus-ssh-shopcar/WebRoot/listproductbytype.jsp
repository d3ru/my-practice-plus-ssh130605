...
<head>
	...
	<title>分类查询</title>
	<SCRIPT language=javascript src="<%=path %>/js/ajax.js" type=text/javascript></SCRIPT>
	<SCRIPT language=javascript src="<%=path %>/js/cart.js" type=text/javascript></SCRIPT>
	<SCRIPT language=javascript src="<%=path %>/js/move.js" type=text/javascript></SCRIPT>
...
<body topmargin="0" bgcolor="#dce0e1" onLoad="load();">
	<table align="center" border="0" width="778" cellspacing="0"
		cellpadding="0">
		<tr valign="top">
			<td>
				...
				<div id="shopsWindow" style="display: none;position: absolute;left:300;top:200;" onmousedown="f_mdown(this)" onmousemove="f_move(this)">
					<div class="shopscontain">
						<div id="shops">
							...
							<div id="shops_carts"></div>
							<center>
								<button onclick="accountSubmit('${pageContext.request.contextPath}');">结算</button>
								&nbsp;&nbsp;&nbsp;
								<button onclick="ShopCartsClear()">清空购物车</button>
							</center>
						</div>
					</div>
				</div> <!-- 购物车界面结束-->
										...
										<tr>
																			...
																			<tr>
																				<td width="100%" align="center">
																					<div id="login" align="center">
																						<login:login verifycodeurl="img.jpg"
																							registryurl="registry.jsp"
																							submitevent="loginRequest()" isajax="true"
																							actionurl="loginservice.do"
																							backcss="css/login.css" background="false"></login:login>
																					</div>
																				</td>
																			</tr>
																		</table>
																...
																<tr>
																	<td colspan="3">
																		<table border="1" width="100%" cellspacing="0" cellpadding="0">
																			<tr>
																				<td id="cata" width="100%" background="images/2.gif"><p
																						align="center">::商品种类::
																				</td>
																			</tr>
																			<tr valign="top" style="height: 160px;margin-bottom: 0px;padding-bottom: 4px;">
																				<td width="100%">
																					<div align="left">
																						<login:menutag submitevent="showprobytype"></login:menutag>
																					</div>
																				</td>
																			</tr>
																		</table>
											...
											<td width="576" valign="top">
												<table style="margin-top: 1px;" width="100%" border="1" cellpadding="0" cellspacing="0">
													<tr>
														<td height="25"><login:productquerytag></login:productquerytag></td>
													</tr>
													<tr>
		...
		<tr valign="top">
			<td><jsp:include flush="true" page="subpage/foot.jsp"></jsp:include></td>
		</tr>
	</table>
</body>
</html>
